...
public:
	...
	ManagerDeProiect(string nume, int nrZile, float sporPerZi, int nrSubordonati, float sporPerSubordonat) :Manager(nrSubordonati, sporPerSubordonat){
