...
int main() {
	...
	Librarie l4(l3);  //constructor de copiere
	Librarie l5 = l3;  //constructor de copiere
	Librarie l6;  //operator egal
	l6 = l3;
	cout << l3;
	cout << l6;
	...
	cout <<endl<< "Numar carti: " << nrCarti << endl;
	cout << "Numarul mediu de carti per angajat " << l3.getNrMediuCartiPerAngajat()<<endl;
